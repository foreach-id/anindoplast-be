...
export class ReceiptService {
  static async getOrderData(deliveryNumber: string): Promise<ReceiptData | null> {
    ...
    const receiptData: ReceiptData = {
      ...
      weight: totalWeight / 1000, // Convert gram ke kg
  ...
  static async generatePDF(data: ReceiptData): Promise<Buffer> {
    try {
